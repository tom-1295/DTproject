...
<div class="container">
	<div class="row">
	        <div class="col-sm-2">
			<figure class="figure">
						<img src="<c:url value="/resources/images/vvvvvv.jpg"/>" class="img-responsive" style="width:100%" alt="Image">
			...
			<div class="col-sm-8">
			   <h1>  <p class="text-center">ACCESORIESS </h1>
...
<nav background="<c:url value="/resources/images/vvvvvv.png"/>" class="navbar navbar-inverse">
