...
.tg .tg-4eph {
 ...
 <body background="<c:url value="/resources/images/m.jpg"/>" >
...
<footer class="container-fluid text-center">
   <img src="<c:url value="/resources/images/23.jpg"/>"  alt="Image" width="360" height="200">
					<p class="bg-danger"><h3>View the list of Products</h3> </p>
